...
func _Operation_AuditAppeal0_HTTP_Handler(srv OperationHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AuditAppeal(ctx, req.(*AuditAppealReques))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type OperationHTTPClient interface {
	AuditAppeal(ctx context.Context, req *AuditAppealReques, opts ...http.CallOption) (rsp *AuditAppealReply, err error)
...
func (c *OperationHTTPClientImpl) AuditAppeal(ctx context.Context, in *AuditAppealReques, opts ...http.CallOption) (*AuditAppealReply, error) {
