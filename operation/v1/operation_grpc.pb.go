...
type OperationClient interface {
	...
	AuditAppeal(ctx context.Context, in *AuditAppealReques, opts ...grpc.CallOption) (*AuditAppealReply, error)
}
...
func (c *operationClient) AuditAppeal(ctx context.Context, in *AuditAppealReques, opts ...grpc.CallOption) (*AuditAppealReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OperationServer interface {
	...
	AuditAppeal(context.Context, *AuditAppealReques) (*AuditAppealReply, error)
...
func (UnimplementedOperationServer) AuditAppeal(context.Context, *AuditAppealReques) (*AuditAppealReply, error) {
...
func _Operation_AuditAppeal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperationServer).AuditAppeal(ctx, req.(*AuditAppealReques))
	}
	return interceptor(ctx, in, info, handler)
}
